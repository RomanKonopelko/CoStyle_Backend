...
const { ERROR, SUCCESS, EMAIL_IS_USED, INVALID_CREDENTIALS, EMAIL_IS_NOT_VERIFIED } = constants_1.HTTP_MESSAGES;
...
const registerUser = async (req, res, next) => {
    try {
        ...
        const emailService = new emailGeneration_1.default(process.env.NODE_ENV, new email_sender_1.default());
